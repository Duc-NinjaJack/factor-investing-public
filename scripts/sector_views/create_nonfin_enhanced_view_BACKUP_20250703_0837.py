...
def create_enhanced_fundamental_view(engine):
    ...
    SELECT 
        ...
        -- ========================================
        -- NEW CASH FLOW ITEMS (Enhanced)
        -- ========================================
        MAX(CASE WHEN fm.en_name = 'I. Net Cash Flow from Operating' THEN fv.value END) as NetCFO,
        MAX(CASE WHEN fm.en_name = 'II. Net Cash Flow from Investing' THEN fv.value END) as NetCFI,
        MAX(CASE WHEN fm.en_name = 'III. Net Cash Flow from Financing' THEN fv.value END) as NetCFF,
