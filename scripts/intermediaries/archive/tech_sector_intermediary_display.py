#!/usr/bin/env python3
"""
Tech Sector Intermediary Values Display
======================================
Displays calculated intermediary values from the database in tabular format
Similar to fundamental validation reports
"""
...
def print_averages_section(df, quarters, output_file):
    ...
    content = []
    content.append(f"## II. 5-Point Balance Sheet Averages 📊\n")
...
def main():
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        ...
        f.write("---\n\n")
        f.write("## Summary\n\n")
        f.write("**🎯 PHASE 2 INTERMEDIARY CALCULATIONS: ✅ COMPLETE FOR TECH SECTOR**\n\n")
        ...
        f.write(f"**Related Scripts**: `scripts/tech_sector_intermediary_calculator.py`\n")
