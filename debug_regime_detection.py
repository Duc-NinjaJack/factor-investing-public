...
def analyze_market_data_characteristics():
    ...
    # Load market data
    engine = strategy_module.create_engine()
    ...
    AND trading_date >= '2016-01-01' 
    AND trading_date <= '2025-12-31'
    ORDER BY trading_date
    """
    
    market_data = pd.read_sql(query, engine, params=())
    market_data['trading_date'] = pd.to_datetime(market_data['trading_date'])
    market_data.set_index('trading_date', inplace=True)
