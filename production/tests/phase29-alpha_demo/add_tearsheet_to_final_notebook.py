#!/usr/bin/env python3
"""
Add tearsheet display cell to the final working strategy notebook
"""
...
# Read the notebook
with open('15_final_working_strategy.ipynb', 'r') as f:
    notebook = json.load(f)

# Find the latest tearsheet file
tearsheet_files = glob.glob('tearsheet_final_working_*.png')
if tearsheet_files:
    ...
    tearsheet_cell = {
        ...
        "metadata": {},
        "source": [
            "# 📊 Final Working Strategy Tearsheet\n\n",
            "Below is the comprehensive performance analysis for the Final Working Strategy:"
        ]
    }
    ...
    image_cell = {
        ...
        "source": [
            ...
            "    plt.imshow(img)\n",
            "    plt.axis('off')\n",
            "    plt.title('Final Working Strategy - Performance Tearsheet', fontsize=16, pad=20)\n",
            "    plt.tight_layout()\n",
            "    plt.show()\n",
            "    \n",
    ...
    with open('15_final_working_strategy.ipynb', 'w') as f:
