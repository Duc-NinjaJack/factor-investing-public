# QVM Engine v3j - Integrated Strategy (Full Implementation)

# %% [markdown]
# # QVM Engine v3j - Integrated Strategy Analysis
# 
# **Objective:** Full implementation of QVM Engine v3j with all components:
# - Regime detection
# - Factor analysis (ROAA, P/E, Momentum)
# - Integrated portfolio construction
# 
# **File:** 04_integrated_strategy.py
...
QVM_CONFIG = {
    # Backtest Parameters
    "strategy_name": "QVM_Engine_v3j_Integrated",
...
print("\n⚙️  QVM Engine v3j Integrated Configuration Loaded:")
...
## QVM ENGINE V3J INTEGRATED

class QVMEngineV3jIntegrated:
    """
    QVM Engine v3j with Integrated Strategy (All Components).
    ...
    def __init__(self, config: dict, price_data: pd.DataFrame, fundamental_data: pd.DataFrame,
        ...
        print("✅ QVMEngineV3jIntegrated initialized.")
    ...
    def run_backtest(self) -> (pd.Series, pd.DataFrame):
        ...
        print("\n🚀 Starting QVM Engine v3j integrated backtest execution...")
        
        rebalance_dates = self._generate_rebalance_dates()
        daily_holdings, diagnostics = self._run_optimized_backtesting_loop(rebalance_dates)
        net_returns = self._calculate_net_returns(daily_holdings)
        
        print("✅ QVM Engine v3j integrated backtest execution complete.")
...
def generate_comprehensive_tearsheet(strategy_returns: pd.Series, benchmark_returns: pd.Series, diagnostics: pd.DataFrame, title: str):
    ...
    (1 + aligned_strategy_returns).cumprod().plot(ax=ax1, label='QVM Engine v3j Integrated', color='#16A085', lw=2.5)
...
if __name__ == "__main__":
    """
    QVM Engine v3j Integrated - MAIN EXECUTION

    This file contains the main execution code for the integrated QVM Engine v3j
    with all components: regime detection, factor analysis, and integrated portfolio construction.
    """

    # Execute the data loading
    try:
        print("\n" + "="*80)
        print("🚀 QVM ENGINE V3J: INTEGRATED STRATEGY EXECUTION")
        print("="*80)
        ...
        # --- Instantiate and Run the Integrated QVM Engine v3j ---
        print("\n" + "="*80)
        print("🚀 QVM ENGINE V3J: INTEGRATED BACKTEST")
        print("="*80)
        ...
        print(f"\n🔍 DEBUG: After integrated backtest")
        ...
        print("\n" + "="*80)
        print("📊 QVM ENGINE V3J: INTEGRATED TEARSHEET")
        print("="*80)
        
        # Full Period Tearsheet (2016-2025)
        print("\n📈 Generating Integrated Strategy Tearsheet (2016-2025)...")
        generate_comprehensive_tearsheet(
            qvm_net_returns,
            benchmark_returns,
            qvm_diagnostics,
            "QVM Engine v3j Integrated - Full Period (2016-2025)"
        )
        ...
        print("\n✅ QVM Engine v3j Integrated strategy execution complete!")
