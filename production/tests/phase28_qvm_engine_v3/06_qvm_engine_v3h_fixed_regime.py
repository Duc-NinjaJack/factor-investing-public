...
QVM_CONFIG = {
    ...
    "regime": {
        ...
        "volatility_threshold": 0.2659, # 75th percentile volatility (fixed)
        "return_threshold": 0.2588,     # 75th percentile return (fixed)
        "low_return_threshold": 0.2131  # 25th percentile return (fixed)
    }
}
