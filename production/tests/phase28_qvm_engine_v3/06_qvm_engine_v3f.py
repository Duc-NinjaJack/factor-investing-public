...
QVM_CONFIG = {
    # --- Backtest Parameters ---
    "strategy_name": "QVM_Engine_v3f_Top200_Universe",
...
print("\n⚙️  QVM Engine v3f Configuration Loaded:")
...
try:
    ...
    # --- Instantiate and Run the QVM Engine v3f ---
    print("\n" + "="*80)
    print("🚀 QVM ENGINE V3F: TOP 200 UNIVERSE")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("📊 QVM ENGINE V3F: COMPREHENSIVE PERFORMANCE REPORT")
    print("="*80)
    ...
    generate_comprehensive_tearsheet(
        ...
        benchmark_returns,
        qvm_diagnostics,
        "QVM Engine v3f with Top 200 Universe (2016-2020)"
    )
    ...
    print("\n✅ QVM Engine v3f with comprehensive performance analysis complete!")
